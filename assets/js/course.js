      ...
      items: [
        { type: "link", icon: "welcome", title: "Boas-vindas ao módulo", path: "/modulo2/apresentacao.html" },
        {
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Informação em saúde", path: "/modulo2/aula1/topico1.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: A notificação compulsória como um instrumento de saúde pública", path: "/modulo2/aula2/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Processo de Notificação de doenças, agravos e eventos", path: "/modulo2/aula2/topico2.html" },
            { type: "link", icon: "lesson", title: "Tópico 3: Fichas de notificação (impressas e digitais) e sistemas de informação em saúde", path: "/modulo2/aula2/topico3.html" },
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Documento", path: "/modulo2/aula3/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Arquivo", path: "/modulo2/aula3/topico2.html" },
            { type: "link", icon: "lesson", title: "Tópico 3: Documento e informação arquivística", path: "/modulo2/aula3/topico3.html" },
            { type: "link", icon: "lesson", title: "Tópico 4: Cuidados com o tratamento de dados de usuários da Atenção Primária em Saúde", path: "/modulo2/aula3/topico4.html" },
            { type: "link", icon: "lesson", title: "Tópico 5: Informações de Saúde nas mídias digitais", path: "/modulo2/aula3/topico5.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            { type: "link", icon: "lesson", title: "Introdução", path: "/modulo2/aula4/introducao.html" },
            { type: "link", icon: "lesson", title: "Tópico 1: O registro", path: "/modulo2/aula4/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Análise da informação em saúde sobre Mpox de forma contextualizada: por quê?", path: "/modulo2/aula4/topico2.html" }
          ]
        },
      ...
      items: [
        { type: "link", icon: "welcome", title: "Boas-vindas ao módulo", path: "/modulo3/apresentacao.html" },
        {
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Papel da APS nos casos de Mpox", path: "/modulo3/aula1/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Enfrentamento de estigmas frente a doença", path: "/modulo3/aula1/topico2.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Um pouco de história das práticas de educação em saúde no Brasil", path: "/modulo3/aula2/topico1.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Educação popular: histórico e principais referências", path: "/modulo3/aula3/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Planejamento das atividades educativas", path: "/modulo3/aula3/topico2.html" }
          ]
        },
      ...
      items: [
        { type: "link", icon: "welcome", title: "Boas-vindas ao módulo", path: "/modulo4/apresentacao.html" },
        {
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Dimensão técnica", path: "/modulo4/aula1/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Dimensão gerencial", path: "/modulo4/aula1/topico2.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Objetivo da realização da vigilância da Mpox nos territórios", path: "/modulo4/aula2/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Indicações para o teste de Mpox", path: "/modulo4/aula2/topico2.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            ...
            { type: "link", icon: "lesson", title: "Tópico 1: Importância de conceitos", path: "/modulo4/aula3/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Determinações sociais para Mpox no território", path: "/modulo4/aula3/topico2.html" },
            { type: "link", icon: "lesson", title: "Tópico 3: O processo de territorialização de informações em saúde no enfrentamento da Mpox", path: "/modulo4/aula3/topico3.html" },
            { type: "link", icon: "lesson", title: "Tópico 4: Ferramentas para realizar a territorialização em saúde", path: "/modulo4/aula3/topico4.html" }
          ]
        },
        {
          type: "accordion",
          ...
          items: [
            { type: "link", icon: "lesson", title: "Introdução", path: "/modulo4/aula4/introducao.html" },
            { type: "link", icon: "lesson", title: "Tópico 1: Planejamento e Programação Local em Saúde (PPLS)", path: "/modulo4/aula4/topico1.html" },
            { type: "link", icon: "lesson", title: "Tópico 2: Ações educativas e comunicativas das práticas de Vigilância em Saúde.", path: "/modulo4/aula4/topico2.html" }
          ]
        },
